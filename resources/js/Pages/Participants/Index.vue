...
const remove = (entry:Entry) => { if (confirm(`Remove ${displayName(entry)} (${bibLabel(entry.bib_number)})?`)) router.delete(`/races/${props.race.id}/participants/${entry.id}`, {preserveScroll:true}); };
