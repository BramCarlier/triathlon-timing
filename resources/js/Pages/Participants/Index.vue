...
<ConfirmDialog v-if="removing" :title="$t('Remove participant?')" :message="`Remove ${displayName(removing)}? Participants with timing history cannot be removed.`" confirm-label="Remove participant" @cancel="removing=null" @confirm="confirmRemove"/>
</AppLayout></template>
