...
const confirmRemove=()=>{if(removing.value)router.delete(`/races/${props.race.id}/participants/${removing.value.id}`,{preserveScroll:true,onSuccess:()=>{removing.value=null;}});};
