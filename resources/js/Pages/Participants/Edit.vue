...
<fieldset v-for="athlete in form.athletes" :key="athlete.id" class="mt-4 grid gap-3 rounded-xl border border-slate-700 p-4 sm:grid-cols-2"><legend>Athlete profile</legend>
