...
<template>
 <Head title="Roles & permissions"/><AppLayout title="Roles & permissions">
  <p class="mb-4 muted">Official roles stay deliberately small: decide whether an Official can record checkpoint times and/or export results. Race setup, athlete registration, checkpoint assignment and race controls always belong to the Organizer (admin).</p>
  <Link href="/users" class="btn-secondary mb-5"><i class="fa-solid fa-users" aria-hidden="true"></i>Assign roles in Users</Link>
