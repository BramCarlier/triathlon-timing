...
const checks=computed(()=>[
 ...
 {label:'Organizers',ready:(props.race.organizers_count??props.race.organizers?.filter(user=>user.is_active!==false).length??0)>0,href:`/races/${props.race.id}#organizers`,detail:'Assign active organizers, then have them open their timing stations.'},
]);
</script>
