...
export interface Race { id: number; name: string; slug: string; event_date: string; timezone: string; status: string; started_at?: string | null; finished_at?: string | null; settings?: Record<string, unknown>; entries_count?: number; public_results_token?:string|null; public_timing_token?:string|null; results_published_at?:string|null }
