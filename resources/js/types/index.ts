...
export interface StationParticipant { id: number; bib_number: string; type: 'solo'|'relay'; name: string; members: Array<{discipline:string;name:string}>; completed_checkpoint_ids: number[] }
