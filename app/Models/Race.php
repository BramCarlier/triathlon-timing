...
class Race extends Model
{
    ...
    protected function casts(): array { return ['event_date' => 'date:Y-m-d', 'status' => RaceStatus::class, 'started_at' => 'datetime:Y-m-d H:i:s.v', 'finished_at' => 'datetime:Y-m-d H:i:s.v', 'settings' => 'array']; }
