...
class AccountInvitation extends Notification {
 ...
 public function toMail(object $notifiable): MailMessage {
  return (new MailMessage)->subject('Your Triathlon Timing account')
   ...
   ->line('An organizer (admin) has created your '.$notifiable->role->label().' account.')
   ...
   ->line('This single-use link expires in '.config('auth.passwords.users.expire',60).' minutes. If it expires, use Forgot password on the sign-in page or ask your organizer (admin) to resend your invitation.')
