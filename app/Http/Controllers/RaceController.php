    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $race = DB::transaction(function () use ($request, $data) {
            ...
            $race->checkpoints()->createMany([
                ...
                ['name' => 'Swim–run transition (Run Start)', 'code' => 'RUN_START', 'sequence' => 20, 'kind' => CheckpointKind::Transition, 'discipline' => Discipline::Run, 'distance_km' => 0, 'is_required' => true],
                ['name' => 'Run Finish', 'code' => 'RUN_FINISH', 'sequence' => 30, 'kind' => CheckpointKind::Transition, 'discipline' => Discipline::Run, 'distance_km' => $data['run_km'] ?? 8, 'is_required' => true],
                ['name' => 'Run–bike transition (Bike Start)', 'code' => 'BIKE_START', 'sequence' => 40, 'kind' => CheckpointKind::Transition, 'discipline' => Discipline::Bike, 'distance_km' => 0, 'is_required' => true],
                ['name' => 'Bike Finish', 'code' => 'BIKE_FINISH', 'sequence' => 50, 'kind' => CheckpointKind::Finish, 'discipline' => Discipline::Bike, 'distance_km' => $data['bike_km'] ?? 35, 'is_required' => true],
            ]);
            return $race;
        });
